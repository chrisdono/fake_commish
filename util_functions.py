...
def fetch_league(league_id: int, year: int, week: int, swid: str, espn_s2: str):
...
def print_weekly_stats_for_team(league: League, team: Team, week: int):
    ...
    print('\n', table(stats_table, headers = ['Week ' + str(week), ''], numalign = 'left', tablefmt='github'))
...
def print_weekly_stats(league: League, week: int, lucky_winners, unlucky_losers):
    ...
    # return table(statsTable, headers = ['Week ' + str(week), ''], tablefmt='github')
...
def print_current_standings(league: League):
    ...
    print('\nWeek {}\n'.format(league.currentMatchupPeriod),  
          table(results_table, 
                ...
                floatfmt = '.2f'))     
    print('\nBD Division Standings Week {}\n'.format(league.currentMatchupPeriod),  
          table(bd_results_table, 
                headers = ['Team', 'Wins', 'Losses', 'Ties', 'Points Scored', 'Owner'], 
                floatfmt = '.2f', tablefmt = 'github'))     
    print('\nJTT Division Standings Week {}\n'.format(league.currentMatchupPeriod),  
          table(jt_results_table, 
                headers = ['Team', 'Wins', 'Losses', 'Ties', 'Points Scored', 'Owner'], 
                floatfmt = '.2f', tablefmt = 'github'))     
    return bd_results_table, jt_results_table

    
def print_power_rankings(league: League, week):
    ''' Inputs: None
        Outputs: table (prints current standings)
        This function prints the current standings for a league.
        This function does NOT account for tiebreakers.
